"""Tests fuer das Hauptfenster der vereinten Anwendung ('gui/main_window.py').
...
from protokoll_assistent_vereint.gui import main_window as mw  # noqa: E402
from protokoll_assistent_vereint.services import (  # noqa: E402
...
def test_vorlage_anwenden_fuellt_editor(fenster):
    from protokoll_assistent_vereint.utils.systemprompt_vorlagen import EINGEBAUTE_VORLAGEN
