"""Gemeinsame Vorbereitungen fuer die Tests der vereinten Anwendung.

Nach demselben Muster wie 'lokale_windows_app/tests/conftest.py': Qt laeuft
unsichtbar ("offscreen"), damit die Tests auch auf einem Build-Server ohne
Bildschirm funktionieren."""
...
def qt_app():
    ...
    Qt erlaubt nur eine Instanz pro Prozess. Laufen die Tests von
    'lokale_windows_app/tests' und hier im selben Prozess, liefert
    'QApplication.instance()' bereits deren Instanz zurueck - das ist
    beabsichtigt, nicht doppelt."""
