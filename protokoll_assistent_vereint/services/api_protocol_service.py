...
'services.ollama_service.generate_json' (aus 'lokale_windows_app') -
...
def generate_json(
    ...
    *,
    ...
    # Spaeter Import, um Zirkelbezuege beim Modulladen zu vermeiden und
    # 'lokale_windows_app' nur dann zu brauchen, wenn diese Funktion
    # tatsaechlich aufgerufen wird (siehe 'api_transcription_service' fuer
    # dasselbe Muster).
