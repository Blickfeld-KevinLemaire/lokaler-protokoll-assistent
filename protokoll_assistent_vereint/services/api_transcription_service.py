...
'services.pipeline_service' (aus 'lokale_windows_app') bereits fuer die
...
def diarize_via_api_speakers(
    ...
    # Lazy: 'lokale_windows_app' liegt nur bedingt auf dem Suchpfad (siehe
    # 'app.py') -- der Import hier passiert erst, wenn diese Funktion
    # tatsaechlich als 'diarize_fn' aufgerufen wird.
