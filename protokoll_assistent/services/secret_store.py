...
Ein API-Schluessel gehoert nie in eine Datei im Klartext (siehe CLAUDE.md,
Regel 3). Der Anwender darf einen Schluessel trotzdem dauerhaft merken
lassen - dafuer wird die Windows-Anmeldeinformationsverwaltung ueber das
Paket 'keyring' benutzt, nicht die Konfigurationsdatei.
...
Modulanfang: Startet die Anwendung im lokalen Modus in der von
'bootstrap.py' selbst verwalteten Laufzeitumgebung
