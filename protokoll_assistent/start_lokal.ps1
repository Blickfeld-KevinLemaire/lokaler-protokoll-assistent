...
# einfach 'protokoll_assistent.app' mit dem System-Python gestartet -- die Anwendung legt
...
if (Test-Path $VenvPython) {
    ...
    Write-Host "Hinweis: Noch keine vorbereitete Umgebung gefunden -- die Anwendung richtet" -ForegroundColor DarkYellow
...
try {
    & $PythonExe -m protokoll_assistent.app
